...
public class MenuDAO extends BaseJdbcDAO implements IMenuDAO {
	...
	public JSONObject getMenu() {
		    ...
		    String query = "select  submenu_t.NAME as SUBMENU,menu_t.ITEM_NAME,menu_t.ITEM_NAME_EN,menu_t.DESCRIPTION_EN,menu_t.PRICE_IN_YTL,menu_t.PRICE_IN_DOLAR,menu_t.PRICE_IN_EURO,menu_t.DESCRIPTION from menu menu_t ,submenu submenu_t where menu_t.SUBMENU_ID=submenu_t.ID";
	...
	public JSONObject getSubmenu(int submenuID) {
	    String query = "select  submenu_t.NAME as SUBMENU,menu_t.ITEM_NAME,menu_t.ITEM_NAME_EN,menu_t.DESCRIPTION_EN,menu_t.PRICE_IN_YTL,menu_t.PRICE_IN_DOLAR,menu_t.PRICE_IN_EURO,menu_t.DESCRIPTION from menu menu_t ,submenu submenu_t where menu_t.SUBMENU_ID=submenu_t.ID and submenu_t.ID=:submenuID";
